...
export default function Bq(props: {}) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" version="1.1" width={45} height={45} {...props}>
      <g style={{opacity: 1, fill: 0, fillOpacity: 1, fillRule: 'evenodd', stroke: '#000000', strokeWidth: '1.5', strokeLinecap: 'round', strokeLinejoin: 'round', strokeMiterlimit: 4, strokeDasharray: 'none', strokeOpacity: 1}}>
        ...
        <path d="M 9,26 C 17.5,24.5 30,24.5 36,26 L 38.5,13.5 L 31,25 L 30.7,10.9 L 25.5,24.5 L 22.5,10 L 19.5,24.5 L 14.3,10.9 L 14,25 L 6.5,13.5 L 9,26 z" style={{strokeLinecap: 'butt', stroke: '#000000'}} />
